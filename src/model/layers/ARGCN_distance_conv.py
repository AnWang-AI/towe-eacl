...
class ARGCN_distance_conv_multi_head(MessagePassing):
    """
    Args:
    ...
    def __init__(self, in_channels, out_channels, edge_feature_dim=2, num_heads=8,
        ...
        super(ARGCN_distance_conv_multi_head, self).__init__(aggr='add', **kwargs)
    ...
    def message(self, x_i, x_j, edge_index_j, size_i, edge_type, edge_distance, edge_norm, ptr):
        ...
        for head_idx in range(self.num_heads):
            ...
            edge_weight = F.leaky_relu(beta, self.negative_slope)
