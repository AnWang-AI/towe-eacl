...
from src.model.layers.ARGCN_dep_distance_conv import ARGCN_dep_distance_conv, ARGCN_dep_distance_conv_v2, ARGCN_dep_distance_conv_v3
...
class ExtractionNet_v2(torch.nn.Module):
    def __init__(self, word_embed_dim, output_size, config_dicts, word_emb_mode="w2v", graph_mode=False):
        super(ExtractionNet_v2, self).__init__()
...
class DeepARGCNNet(torch.nn.Module):
    def __init__(self, num_features=768, num_classes=9, edge_feature_dim=2, num_mid_layers=3):
        ...
        conv_layer = ARGCN_dep_distance_conv_v3
