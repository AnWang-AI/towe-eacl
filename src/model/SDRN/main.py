...
def bert_load_state_dict(model, state_dict):
    ...
    def load(module, prefix=''):
        ...
        module._load_from_state_dict(state_dict, prefix, local_metadata, True, missing_keys, unexpected_keys, error_msgs) # add arg: local_metadata=None
...
def main(args):
    ...
    # train_dataloader = read_data(test_set, "test", args.batchSize)
    ...
    if args.mode == "test":
        ...
        # evaluate
        RP, RR, RF, TP, TR, TF, OP, OR, OF = evaluate(eval_dataloader, test_set, model, args.test_eval_dir + "/test_output", args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bert_json_dir', type=str,
                        default="/Users/jiangjunfeng/mainland/private/towe-eacl/model/uncased_L-12_H-768_A-12/bert_config.json")
    parser.add_argument('--bert_checkpoint_dir', type=str,
                        default="/Users/jiangjunfeng/mainland/private/towe-eacl/model/uncased_L-12_H-768_A-12/pytorch_model.bin")
