...
if __name__ == '__main__':
    ...
    # print(A)
    train_features = convert_examples_to_features(train_set, tokenizer, max_seq_length=args.max_seq_length)
    dev_features = convert_examples_to_features(dev_set, tokenizer, max_seq_length=args.max_seq_length)
    test_features = convert_examples_to_features(test_set, tokenizer, max_seq_length=args.max_seq_length)
